...
void pacifica_one_layer(CRGB* leds, int numLeds, CRGBPalette16& p, uint16_t cistart, uint16_t wavescale, uint8_t bri, uint16_t ioff);
...
void Pacifica::update(Strip& strip) const {
...
void pacifica_loop(CRGB* leds, int numLeds) {
  ...
  pacifica_one_layer(leds, numLeds, pacifica_palette_1, sCIStart1, beatsin16( 3, 11 * 256, 14 * 256), beatsin8( 10, 70, 130), 0-beat16( 301) );
  pacifica_one_layer(leds, numLeds, pacifica_palette_2, sCIStart2, beatsin16( 4,  6 * 256,  9 * 256), beatsin8( 17, 40,  80), beat16( 401) );
